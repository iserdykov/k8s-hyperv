...
function examples() {
  ...
  create-machine -switch 'switch' -vmname 'master' -cpus 4 -mem 4GB -hdd 40GB -vhdxtmpl $vhdxtmpl -cblock '10.10.0' -ip '10' #-mac mac1
  create-machine -switch 'switch' -vmname 'node1' -cpus 4 -mem 4GB -hdd 40GB -vhdxtmpl $vhdxtmpl -cblock '10.10.0' -ip '11' #-mac mac2
  create-machine -switch 'switch' -vmname 'node2' -cpus 4 -mem 4GB -hdd 40GB -vhdxtmpl $vhdxtmpl -cblock '10.10.0' -ip '12' #-mac mac3
